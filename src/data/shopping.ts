...
export const SHOPPING: ShopPhase[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "b29al5", name: "4G/LTE WAN failover modem", meta: "USB/Ethernet 4G on the UCG-Max — alerts still escape if broadband is cut (the DIY-alarm weak point).", cost: 60, costLabel: "~£40-80", search: "4G LTE USB modem router failover" },
